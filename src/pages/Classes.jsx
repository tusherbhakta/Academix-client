      ...
      <div className="flex gap-4 mb-6">
        <button
          className={`px-4 py-2 rounded font-semibold transition ${
            sortOrder === "asc" ? "bg-yellow-400 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-300"
          }`}
        ...
        <button
          className={`px-4 py-2 rounded font-semibold transition ${
            sortOrder === "desc" ? "bg-yellow-400 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-300"
          }`}
